...
Error:
  ...
  public:
    ...
    Result Read(TBinary& f, VersionStructHeader& header)
    {
      ...
      {
        ret.Fail(Format("ValueLength is wrong.  Expected: 0, actual: %.")(hdr.valueLength).Str());
        goto Error;
      }
...
Error:
  ...
  public:
    ...
    Result Read(TBinary& f, VersionStructHeader& header)
    {
      ...
      {
        ret.Fail(Format("The valueLength field was incorrect.  Expected %, it is %.  The value is %")((int)GetValueLengthChars())((int)hdr.valueLength).qs(value).Str());
        goto Error;
      }
...
Error:
  ...
  public:
    ...
    Result Read(TBinary& f, VersionStructHeader& header)
    {
      ...
      return ret.Succeed();
Error:
      return ret.Prepend(Format("Error reading a % structure; ")(name).Str());
    }
    ...
    Result Write(TBinary& f)
    {
      ...
      return ret.Succeed();
Error:
      return ret.Prepend(Format("Error writing a % structure; ")(name).Str());
    }
  ...
  public:
    ...
    Result Read(TBinary& f)
    {
      ...
      {
        ret.Fail(Format("The value length is incorrect.  Expected %; it is %")((int)GetValueLength())((int)hdr.valueLength).Str());
        goto Error;
      }
